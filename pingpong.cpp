...
int main()
{
    ...
    //variables
    float y_pad1 = 0, x_ball = -5, y_ball = -5;
    float y_pad2 = 0;
    ...
    //font
    sf::Font font;
    if (font.loadFromFile("arial.ttf") == 0) return 1;
    ...
    if (padimage.loadFromFile("pad.png") == false) return 1;
    if (ballimage.loadFromFile("data/ball.png") == false) return 1;
    if (backimage.loadFromFile("background.png") == false) return 1;

    //Soundeffect
    sf::SoundBuffer buf;
    if (buf.loadFromFile("hit.wav") == 0) return 1;
